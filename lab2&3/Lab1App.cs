...
namespace Labs
{
	...
	class Lab1App
	{
		...
		static void Main(string[] args)
		{
			...
			_dm = dm;
			dm.CircleAdded += s => Console.WriteLine(s);
		...
		private static void printMainMenu()
		{
			...
			Console.WriteLine("3 - Insert new tirangle");
			...
			{				
				...
				if(input.Trim()!="")
				{
					try
					{
						...
						_dm.OnCircleAdded(myCircle.positionData());
        ...
        {
			Console.WriteLine("You are in sub menu for triangle - insert the values for the side and height of triangle :");
			Console.Write("Side of triangle=");
			string inputSide,inputHeight;
			while (true)
			{
				inputSide = Console.ReadLine();
				inputHeight = Console.ReadLine();
				if (inputSide.Trim() != "" && inputHeight.Trim() != "")
				{
					try
					{
						double a = System.Convert.ToDouble(inputSide);
						double b = System.Convert.ToDouble(inputHeight);
						...
						while (true)
						{
							...
							if (s == "y")
							{
								Console.Write("Side and height of triangle=");
								break;
							}
							else if (s == "n")
							{
